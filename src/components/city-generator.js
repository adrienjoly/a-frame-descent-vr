  ...
  init() {
    ...
    for (let gx = -half; gx <= half; gx++) {
      for (let gz = -half; gz <= half; gz++) {
        ...
        tower.setAttribute('material', `color: ${towerColor}; roughness: 0.9; metalness: 0.18;`);
        ...
        if (Math.random() < 0.35) {
          ...
          base.setAttribute('material', 'color: #2f3648; roughness: 1; metalness: 0.12;');
        ...
        if (Math.random() < 0.78) {
          ...
          for (let side = 0; side < sideCount; side++) {
            ...
            const windowCount = 3 + Math.floor(Math.random() * 6);
        ...
        if (h > 70 && Math.random() < 0.85) {
          ...
          roof.setAttribute('material', 'color: #596279; roughness: 0.85; metalness: 0.2;');
          this.el.appendChild(roof);
        }

        if (h > 95 && Math.random() < 0.7) {
